            ...
            <div class="content d-flex justify-content-between gap-5">
                <div class="statistics ms-5">
                    ...
                    <div class="group-survey d-flex align-items-baseline gap-5">
                        <div class="card" style="background-image: url(/../project-survey/assets/images/rating.jpg); background-size: cover; background-repeat: no-repeat;">
                            <div class="card-body d-flex">
                              <h6 class="card-title fw-semibold mt-1">Kualitas Pengajaran dan Pembelajaran</h6>
                            </div>
                        </div>
                        <div class="card" style="background-image: url(/../project-survey/assets/images/layanan.jpg); background-size: cover; background-repeat: no-repeat;background-position-y: -20px;">
                            <div class="card-body d-flex">
                ...
                <aside class="me-5">
                    ...
                    <div class="group-survey d-flex flex-column gap-4">
                            <div class="card" style="background-image: url(/../project-survey/assets/images/fasilitas.jpg); background-size: cover; background-repeat: no-repeat;">
