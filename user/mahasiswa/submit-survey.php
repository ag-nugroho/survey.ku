    ...
    if ($result_survey) {
        ...
        foreach ($_POST as $key => $value) {
            if (strpos($key, 'pertanyaan') === 0) {
                ...
                $query_jawaban = "INSERT INTO t_jawaban_mahasiswa (user_id, survey_id, survey_kategori_id, soal_id, jawaban) VALUES ('$user_id', '$survey_id', '$survey_kategori_id', '$soal_id', '$jawaban')";
